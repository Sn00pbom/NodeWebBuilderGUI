...
def printInfo():
    display = controller.activeGUI.DISPLAY
    ...
    my_string = "A: normal node mode\nS: zone node mode\nD: delete selected node\nF: 1 way link (no tether)\nG: 2 way link (tether)\nZ: debug command\nN: change node name"
    my_rect = pygame.Rect((40, 40, 300, 300))

    rendered_text = render_textrect(my_string, my_font, my_rect, settings.BLACK, settings.WHITE, 0)
